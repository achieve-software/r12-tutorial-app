...
const EditTutorial = ({ item, getTutorials }) => {
  ...
  console.log(oldTitle, oldDescription);  const [title, setTitle] = useState(oldTitle);
  const [description, setDescription] = useState(oldDescription);  console.log(title);
  ...
  const handleEdit = (e) => {
   ...
   const editTutorial = async (id, title, description) => {
    const BASE_URL = "https://tutorial-api.fullstack.clarusway.com/tutorials/";    try {
